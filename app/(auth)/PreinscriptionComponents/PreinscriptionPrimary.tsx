...
import { EdgeMainSpecialty, EdgeSchoolHigherInfo } from "@/utils/schemas/interfaceGraphql";
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {step === 3 && (
          <Step3Specialty
            ...
            apiLevels={[]}
            apiLevelsSec={[]}
            apiLevelsPrim={data?.getLevelsPrim}
            apiYears={[]}
            apiYearsSec={[]}
            apiYearsPrim={data?.allAcademicYearsPrim}
            apiPrograms={[]}
            apiProgramsSec={[]}
            apiProgramsPrim={data?.allProgramsPrim}
            />
        )}
        {step === 4 && (
          <Step4Confirmation
...
export default PreinscriptionPrimary
